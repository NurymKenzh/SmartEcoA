...
namespace SmartEcoA.Models
{
    public class CarPostDataAutoTest
    {
        ...
        // K_1
        // Показатель ослабления сетевого потока K №1, 1/м
        public decimal K_1 { get; set; }

        // K_2
        // Показатель ослабления сетевого потока K №2, 1/м
        public decimal K_2 { get; set; }

        // K_3
        // Показатель ослабления сетевого потока K №3, 1/м
        public decimal K_3 { get; set; }

        // K_4
        // Показатель ослабления сетевого потока K №4, 1/м
