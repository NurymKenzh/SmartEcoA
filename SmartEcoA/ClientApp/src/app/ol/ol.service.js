...
var Stamen_1 = require("ol/source/Stamen");
var olProj = require("ol/proj");
var OLService = /** @class */ (function () {
    function OLService() {
        this.HEREappId = 'SLdBasp4s1oq2oUbVGxy';
        this.HEREappCode = 'D9-h9iVhjgUB_9eUlFETXA';
        this.HEREurlTemplate = 'https://{1-4}.{base}.maps.cit.api.here.com' +
            '/{type}/2.1/maptile/newest/{scheme}/{z}/{x}/{y}/256/png' +
            '?app_id={app_id}&app_code={app_code}';
        this.HERElayerDescNormalDay = {
            base: 'base',
            type: 'maptile',
            scheme: 'normal.day',
        ...
        this.HERElayerDescNormalDayTransit = {
            base: 'base',
            type: 'maptile',
        ...
        this.backgrounds = {
            Source_OSM: new OSM_1.default(),
            Source_BingAerialWithLabels: new BingMaps_1.default({
                key: 'AvXWBeyEt0tMq0Cmi-TdlXA6qG2GDpuV1UcSbSqNXbfHcQ41GFYtjpu0gz8RS6-b',
                imagerySet: 'AerialWithLabels',
            }),
            Source_BingRoadStatic: new BingMaps_1.default({
                key: 'AvXWBeyEt0tMq0Cmi-TdlXA6qG2GDpuV1UcSbSqNXbfHcQ41GFYtjpu0gz8RS6-b',
                imagerySet: 'Road',
            }),
            Source_BingRoadDynamic: new BingMaps_1.default({
                key: 'AvXWBeyEt0tMq0Cmi-TdlXA6qG2GDpuV1UcSbSqNXbfHcQ41GFYtjpu0gz8RS6-b',
                imagerySet: 'RoadOnDemand',
            }),
            Source_HERENormalDay: new XYZ_1.default({
                url: this.HEREcreateUrl(this.HEREurlTemplate, this.HERElayerDescNormalDay),
                attributions: 'Map Tiles &copy; ' + new Date().getFullYear() + ' ' +
                    '<a href="http://developer.here.com">HERE</a>'
            }),
            Source_HERENormalDayTransit: new XYZ_1.default({
                url: this.HEREcreateUrl(this.HEREurlTemplate, this.HERElayerDescNormalDayTransit),
                attributions: 'Map Tiles &copy; ' + new Date().getFullYear() + ' ' +
                    '<a href="http://developer.here.com">HERE</a>'
            }),
            Source_HERETerrainDay: new XYZ_1.default({
                url: this.HEREcreateUrl(this.HEREurlTemplate, this.HERElayerDescTerrainDay),
                attributions: 'Map Tiles &copy; ' + new Date().getFullYear() + ' ' +
                    '<a href="http://developer.here.com">HERE</a>'
            }),
            Source_HEREHybridDay: new XYZ_1.default({
                url: this.HEREcreateUrl(this.HEREurlTemplate, this.HERElayerDescHybridDay),
                attributions: 'Map Tiles &copy; ' + new Date().getFullYear() + ' ' +
                    '<a href="http://developer.here.com">HERE</a>'
            }),
            Source_StamenWatercolor: new Stamen_1.default({
                layer: 'watercolor'
            }),
            Source_StamenTerrain: new Stamen_1.default({
                layer: 'terrain'
            }),
            Source_StamenToner: new Stamen_1.default({
                layer: 'toner'
            }),
            Source_ArcGIS: new XYZ_1.default({
                attributions: 'Tiles © <a href="https://services.arcgisonline.com/ArcGIS/' +
                    'rest/services/World_Topo_Map/MapServer">ArcGIS</a>',
                url: 'https://server.arcgisonline.com/ArcGIS/rest/services/' +
                    'World_Topo_Map/MapServer/tile/{z}/{y}/{x}'
            }),
            Source_ThunderforestOpenCycleMap: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestTransport: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/transport/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestLandscape: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/landscape/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestOutdoors: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/outdoors/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestTransportDark: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/transport-dark/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestSpinalMap: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/spinal-map/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestPioneer: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/pioneer/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestMobileAtlas: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/mobile-atlas/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            }),
            Source_ThunderforestNeighbourhood: new XYZ_1.default({
                url: 'https://{a-c}.tile.thunderforest.com/neighbourhood/{z}/{x}/{y}.png' +
                    '?apikey=6746f4299ea3479aba8726b09f049c1b'
            })
        };
    }
    OLService.prototype.olmap = function () {
        var _this = this;
        ...
        setTimeout(function () { _this.map.updateSize(); });
    ...
    OLService.prototype.changeBackground = function (background) {
        var component = this;
    ...
    OLService.prototype.HEREcreateUrl = function (template, HERElayerDesc) {
        return template
...
exports.OLService = OLService;
//# sourceMappingURL=ol.service.js.map